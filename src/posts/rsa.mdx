...
You can check wich is the maxiumum reporesentable number in Javascript by:
```javascript
console.log(Number.MAX_SAFE_INTEGER);
// Expected output: 9007199254740991
```

This limitation is especially important in cryptographic contexts like RSA, where we deal with very large integers—hundreds or even 
